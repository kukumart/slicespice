    ...
    <main className="min-h-screen bg-background pt-32 pb-24 px-4">
      ...
      <div className="max-w-4xl mx-auto space-y-12">
        <div className="text-center space-y-4">
          <h1 className="text-4xl font-bold">Tracking Your <span className="text-gold">Cravings</span></h1>
        ...
        <GlassCard className="p-10 space-y-12">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
            <div className="space-y-2">
              ...
              <h2 className="text-5xl font-bold text-gold flex items-center gap-4">
                <Clock className="w-10 h-10" />
                25-30 <span className="text-lg text-foreground/50">min</span>
              </h2>
            </div>
              ...
              return (
                <div key={step.id} className={`flex md:flex-col items-start gap-4 transition-all duration-500 ${isActive ? 'opacity-100' : 'opacity-20 grayscale'}`}>
                  ...
                  <div className="space-y-1">
                    <p className={`font-bold ${isProcessing ? 'text-gold' : ''}`}>{step.name}</p>
        ...
        <div className="text-center">
          <p className="text-muted-foreground text-sm">
            Need help with your order? <span className="text-gold cursor-pointer hover:underline font-bold">Contact Support</span>
          </p>
        </div>
      </div>
    </main>

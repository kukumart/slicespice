...
import { Loader2, LogIn, UserPlus, ShieldCheck, UserCircle } from "lucide-react"
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 gap-4">
              <Button 
                ...
                className="w-full glass h-14 rounded-2xl font-black text-xs border-white/10 uppercase tracking-widest hover:bg-white/10 transition-all flex items-center justify-center gap-3 group relative overflow-hidden"
              >
                {isGoogleLoading ? (
